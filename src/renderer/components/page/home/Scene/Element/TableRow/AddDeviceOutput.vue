...
<script>
import { getDefaultIconDevice, getActiveDeviceFromVal, controllDeviceDefault } from "@/plugins/helper";
import {DEVICE_TYPE_CAN_CONTROLL_DEFAULT } from "@/plugins/variableConst";
