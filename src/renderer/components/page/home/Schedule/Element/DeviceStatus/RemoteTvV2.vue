  ...
  <div class="state-device">
    <div class="state">
      {{
        ...
        $t('devices.ir_tv_v2.' + currentComand)
      }}
    </div>
    <!--            SELECT STATE-->
    <div class="state setState remote-irv2-tv">
      <div class="row">
        ...
        <div class="col-lg-8  ">
          <div class="controll-remote-modal controll-remote-tv-v2-modal">
            ...
            <div class="m-3 py-3 bg-1 border-radius-2">
              <div class="controll-form controll-remote-tv-v2">
                <!-- row1 -->
                <div class="set-up" >
                ...
                <div>
                  ...
                  <div class="center-controll">
                    <div class="button-tv top" @click="clickBtn(IRV2_ID_TV.up)">
                      <i class="icon-icon-ir-tv-arrow-up"></i>
                    </div>
                    <div class="button-tv right" @click="clickBtn(IRV2_ID_TV.right)">
                      <i class="icon-icon-ir-tv-arrow-right"></i>
                    </div>
                    <div class="button-tv left" @click="clickBtn(IRV2_ID_TV.left)">
                      <i class="icon-icon-ir-arrow-left-01"></i>
                    </div>
                    <div class="button-tv bottom" @click="clickBtn(IRV2_ID_TV.down)">
