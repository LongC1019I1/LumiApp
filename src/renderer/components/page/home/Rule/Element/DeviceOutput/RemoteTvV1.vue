<template>
  <div class="controll-remote-modal controll-remote-tv-v1-modal">
    <div class="border-radius-1 p-2 bg-disabled2 text-overflow-hidden">{{$t('devices.ir_tv_v1.'+currentComand)}}</div>
